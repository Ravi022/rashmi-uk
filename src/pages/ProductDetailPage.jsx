...
import fittingsBlueSocket from '../assets/fittings-blue-socket.png'
import fittingsRedFlanged from '../assets/fittings-red-flanged.png'
import fittingsRedSocket from '../assets/fittings-red-socket.png'
import fittingsCoating from '../assets/fittings-coating.jpg'
import fittingsProduction from '../assets/fittings-production.jpg'
...
const productImageGallery = {
  'di-pipes': [
    ...
    { src: pipesFlangedEnds, caption: 'Flanged Pipe Ends — Cement Mortar Lined Interior' },
  ...
  'di-fittings': [
    { src: fittingsBlueFlanged, caption: 'Flanged Bend — Cement Mortar Lined, Epoxy Coated' },
    { src: fittingsBlueSocket, caption: 'Socket Bend — Push-fit Joint, Blue Epoxy Coated' },
    { src: fittingsRedFlanged, caption: 'Flanged Bend — EN 545 Compliant, Cement Mortar Lined' },
    { src: fittingsRedSocket, caption: 'Socket Bend — Push-fit Joint, Red Epoxy Coated' },
    { src: fittingsCoating, caption: 'Epoxy Coating Process — Factory Quality Control' },
    { src: fittingsProduction, caption: 'Flanged Fittings — Shot Blasted Surface Preparation' },
  ],
}

const standards = {
  'di-pipes': ['BS EN 545', 'ISO 2531', 'ISO 9001'],
  'di-fittings': ['EN 545', 'EN 598', 'ISO 9001'],
  'di-flanged-pipes': ['EN 545', 'PN 10–40', 'ISO 9001'],
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-slate-950 pb-20 pt-24 text-white">
        ...
        <div className="section-shell relative">
          ...
          <h1 className="font-display mt-4 text-4xl leading-tight text-white md:text-6xl">{product.name}</h1>
          <p className="mt-5 max-w-2xl text-base leading-8 text-slate-300">{product.overview}</p>
